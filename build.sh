...
# Builds HYDRA-UMC-DEV-SERVER: creates/activates a venv, installs the project
# (editable, with dev extras), verifies it compiles/imports cleanly, and
# runs the real test suite. Run this before run.sh.
#
# Usage:
...
python -m py_compile src/hydra_umc_dev_server/__init__.py src/hydra_umc_dev_server/config.py src/hydra_umc_dev_server/inventory.py src/hydra_umc_dev_server/cli.py
python -c "import hydra_umc_dev_server; print('import OK - version', hydra_umc_dev_server.__version__)"
echo "      Done."
echo
...
echo " ==============================================================="
echo "  Build complete. Run ./run.sh to see a real config-validate + inventory demo."
echo " ==============================================================="
echo
