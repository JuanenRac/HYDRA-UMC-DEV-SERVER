...
echo.
echo *****************************************************************************
echo * HYDRA-UMC-DEV-SERVER - build.bat
...
REM Builds HYDRA-UMC-DEV-SERVER: creates/activates a venv, installs the project
...
echo  ===============================================================
echo   Build complete. Run run.bat to see a real config-validate + inventory demo.
echo  ===============================================================
echo.
pause
exit /b 0
